{!! Form::open(array('url'=>url('load_and_rebuild?clear=yes'),'class'=>'form-horizontal','id'=>'build_node_form','enctype'=>'multipart/form-data','style'=>'display: none')) !!}

    {{ Form::hidden('_token',csrf_token()) }}

    <div class="alert alert-info" role="alert">
        <img src="{{ asset('images/csv.png') }}" class="action-title-image">
        <strong>Build tree from CSV file</strong>
    </div>                
    ...
    <div style='text-align: center;  margin-top: 30px'>
        ...
        <div id='cancel_build_action' class='btn btn-default'>Cancel</div>
    </div>
